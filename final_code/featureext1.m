function varargout = featureext1(varargin)
% FEATUREEXT1 M-file for featureext1.fig
%      FEATUREEXT1, by itself, creates a new FEATUREEXT1 or raises the existing
%      singleton*.
%
%      H = FEATUREEXT1 returns the handle to a new FEATUREEXT1 or the handle to
%      the existing singleton*.
%
%      FEATUREEXT1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FEATUREEXT1.M with the given input arguments.
%
%      FEATUREEXT1('Property','Value',...) creates a new FEATUREEXT1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before featureext_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to featureext1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help featureext1

% Last Modified by GUIDE v2.5 15-Aug-2011 12:40:04
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @featureext1_OpeningFcn, ...
                   'gui_OutputFcn',  @featureext1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before featureext1 is made visible.
function featureext1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to featureext1 (see VARARGIN)

% Choose default command line output for featureext1
...
% UIWAIT makes featureext1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = featureext1_OutputFcn(hObject, eventdata, handles) 
...
for i11=1:2 % for 3 time log iteration loop for sorting images
