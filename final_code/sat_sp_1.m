...
%in_img1 = imread('g.jpg'); % read the image
% display the results
...
% in_img2 = imread('first.jpg'); % read the image
...
% in_img3 = imread('second.jpg'); % read the image
...
% in_img4 = imread('three.jpg'); % read the image
...
% in_img5 = imread('four.jpg'); % read the image
% display the results
