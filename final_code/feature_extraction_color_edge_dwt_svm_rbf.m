...
for ii=1:pp
    ...
    H_100_DATA(:,ii)=[counts1 ;counts2; counts3;fet_edge;fet_ca;fet_cd;fet_cv;fet_ch];
...
%         svmStruct = svmtrain(data,groups);  
        svmStruct = svmtrain(data,groups,'KERNEL_FUNCTION','rbf','RBF_Sigma',0.9);  
...
% store feature 
save('color_feature_svm_rbf','svmStruct','H_100_DATA')
toc
